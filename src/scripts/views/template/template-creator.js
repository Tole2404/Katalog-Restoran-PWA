...
<div class="detail-resto">
    ...
    <img class="card-detail" crossorigin="anonymous" src=${CONFIG.BASE_IMAGE_URL + restaurant.pictureId} alt=${restaurant.name} />
...
const createRestaurantItemTemplate = (restaurant) => `
    <div class="card">
        <img class="card_thumb" crossorigin="anonymous" src="${CONFIG.BASE_IMAGE_URL + restaurant.pictureId}" alt="${restaurant.name}"/>
